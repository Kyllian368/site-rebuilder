            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 mb-5 leading-relaxed">
                  Nous sommes une équipe locale, attachée à Toulouse et à sa
                  région. Nous connaissons ses quartiers, ses rythmes, ses
                  voyageurs — et nous mettons cette proximité au service des
                  propriétaires qui nous font confiance.
                </p>
                <p className="text-gray-600 mb-5 leading-relaxed">
                  L'idée est simple : gérer votre bien comme si c'était le
                  nôtre, avec sérieux, disponibilité et un vrai souci du
                  détail. Pas de plateforme impersonnelle, pas de standard
                  téléphonique : un interlocuteur qui vous connaît, vous et
                  votre logement.
                </p>
                <p className="text-gray-600 mb-5 leading-relaxed">
                  Nous nous appuyons également sur un réseau de partenaires
                  locaux de confiance — décorateurs d'intérieur, artisans,
                  agents immobiliers et autres professionnels de l'habitat —
                  afin d'accompagner nos propriétaires bien au-delà de la
                  simple gestion locative et de valoriser durablement leur
                  bien.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  <strong className="font-playfair font-semibold text-elegant-black">
                    Kyllian, fondateur
                  </strong>{' '}
                  — 3 ans d'expérience dans la location courte durée à
                  Toulouse.
                </p>
              </div>
            </div>
        ...
        <section className="bg-elegant-gray">
          <div className="container mx-auto px-6 py-16 md:py-20 text-center max-w-3xl">
            ...
            <p className="text-gray-600 mb-8">
              Un échange simple pour comprendre vos besoins et vous proposer la
              formule la plus adaptée à votre bien.
            </p>
            <Link
              to="/discutons"
