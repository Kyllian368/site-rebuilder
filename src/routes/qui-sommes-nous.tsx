  ...
  return (
    <div className="min-h-screen bg-white text-elegant-black">
      ...
      <main className="pb-20">
        ...
        <section className="py-14 md:py-16 bg-white">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                <p className="text-xs tracking-[0.25em] text-[#941101] font-semibold mb-3 uppercase">
                  Notre histoire
                </p>
                <h2 className="font-playfair text-3xl md:text-4xl font-bold text-elegant-black mb-4">
                  Une conciergerie toulousaine, à taille humaine
                </h2>
        ...
        {/* Section Suite */}
        <section className="pt-2 pb-10 md:pb-12 bg-white">
